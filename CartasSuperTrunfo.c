...
int main(){
    ...
    scanf("%s", &codestado1);
    printf("Insira o codigo do segundo estado estado: \n");
    scanf(" %s", &codestado2);
    ...
    poder1 = area1 + pontosturistico1 + populacao1 + pib1 + pibcapta1 - densipopula1;
    poder2 = area2 + pontosturistico2 + populacao2 + pib2 + pibcapta2 - densipopula2;

    //mostra de dados que foram inseridos pelo usuario lado a lado:
    printf("Cod Estado - Primeira cidade: %c - Segunda cidade: %c\n", codestado1, codestado2);
    printf("Cod Cidade - Primeira cidade: %s - Segunda cidade: %s\n", codcidade1, codcidade2);
    printf("Nome da Cidade - Primeira Cidade: %s - Segunda Cidade: %s\n", nomecidade1, nomecidade2);
    printf("Quantidade de pontos turisticos - Primeira cidade: %d - Segunda Cidade: %d\n", pontosturistico1, pontosturistico2);
    printf("População - Primeira Cidade: %d - Segunda Cidade: %d\n", populacao1, populacao2);
    printf("Area - Primeira Cidade: %.2f km2 - Segunda Cidade: %.2f km2\n", area1, area2);
    printf("Densidade populacional - Primeira Cidade: %.2f - Segunda Cidade %.2f\n", densipopula1, densipopula2);
    printf("PIB - Primeira Cidade: %.2f bilhoes - Segunda cidade: %.2f bilhões\n", pibresultado1, pibresultado2);
    printf("PIB percapta - Primeira cidade: %.2f - Segunda cidade: %.2f\n", pibcapta1, pibcapta2);
    printf("Superpoder - Primeira Cidade: %.2f - Segunda Cidade: %.2f\n", poder1, poder2);
